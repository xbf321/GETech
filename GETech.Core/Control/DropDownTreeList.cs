...
namespace GETech.Control
{
    ...
    public class DropDownTreeList : WebControl, IPostBackDataHandler, IPostBackEventHandler
    {
        ...
        private bool enableOptionGroup = false;
        /// <summary>
        /// 是否启用OptionGroup
        /// </summary>
        public bool EnableOptionGroup {
            get { return enableOptionGroup; }
            set { enableOptionGroup = value; }
        }
        private int optionGroupFlagId = 0;
        public int OptionGroupFlagId {
            get { return optionGroupFlagId; }
            set { optionGroupFlagId = value; }
        }
